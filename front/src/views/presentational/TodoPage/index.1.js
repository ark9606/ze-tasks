...
const Todo = ({name, time, description, done, onDoneChange, onDeleteTodo}) => {
  ...
  return (
    <div className='todo'>    
      <div className='row'>
        ...
        <div className='todo_delete_btn' onClick={onDeleteTodo} title="Delete">✖</div> 
      </div>
    </div>
  );
}
...
class App extends React.Component {
  ...
  onNextPage(val) {
    ...
    .then(forecast => {
      // this.setState({ current: newCurr, forecast })
